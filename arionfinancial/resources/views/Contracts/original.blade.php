...
<div class="container">
	...
	<div class="bill-statement">
		...
		<div class="statement">
			<table align="right">
				<tr>
					<td>Statement Date </td><td><input type="text" value="4/30/2012"></td>
				</tr>
				<tr>
					<td>Statement# </td><td><input type="text" value="[100]"></td>
				</tr>
				<tr>
					<td>Customer ID </td><td><input type="text" value="[ABC123]"></td>
				</tr>
			</table>
		</div>
	</div>
